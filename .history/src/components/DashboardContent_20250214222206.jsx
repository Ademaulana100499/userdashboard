    ...
    <div className="flex-1 p-4">
      ...
      <div className="flex justify-center items-center mt-4 space-x-2">
        ...
        <button
          ...
          className="px-4 py-2 border border-blue-500 text-white   disabled:border-gray-300">
          &lt;
        </button>
        ...
        <button
          ...
          className={`px-4 py-2 border-blue-500 text-white   ${
            currentPage === 1 ? "border-blue-700" : ""
          }`}>
          1
        </button>
        ...
        <button
          ...
          className="px-4 py-2 border-blue-500 text-white   disabled:border-gray-300">
          &gt;
        </button>
      </div>
    </div>
