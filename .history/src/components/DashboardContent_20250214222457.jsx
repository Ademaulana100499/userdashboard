    ...
    <div className="flex-1 p-4">
      ...
      <div className="flex justify-center items-center mt-4 space-x-2">
        ...
        <button
          ...
          className="px-4 py-2 border border-gray-300    disabled:text-gray-300">
          &lt;
        </button>
        ...
        <button
          ...
          className="px-4 py-2 bg-blue-500 border border-gray-300  hover:bg-blue-600 disabled:text-gray-300">
          &gt;
        </button>
      </div>
    </div>
