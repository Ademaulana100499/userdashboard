      ...
      <table className="min-w-full table-auto border-collapse border border-slate-300">
        <thead>
          <tr className="bg-slate-100">
            <th
              className="border border-slate-300 px-6 py-3 text-left cursor-pointer"
              onClick={() => requestSort("username")}>
              Username
            </th>
            <th
              className="border border-slate-300 px-6 py-3 text-left cursor-pointer flex items-center justify-between"
        ...
        <tbody>
          {sortedData.map((user, index) => (
            <tr key={index} className="hover:bg-slate-50">
              ...
              <td className="border border-slate-300 px-6 py-3">{user.name}</td>
              <td className="border border-slate-300 px-6 py-3">
                {user.email}
              </td>
              <td className="border border-slate-300 px-6 py-3">
